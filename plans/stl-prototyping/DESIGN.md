...
|---|---|---|
| CAD wall-clock timeout | 30 s | Kills the process group; `BUILD_TIMEOUT`; partial output discarded. A recursive or unbounded CSG operation will otherwise eat the machine. |
